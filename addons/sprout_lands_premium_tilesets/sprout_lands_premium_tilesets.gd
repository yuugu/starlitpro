...
const PLUGIN_NAME = "Sprout Lands Premium TileSets"
const PROJECT_SETTINGS_PATH = "sprout_lands_premium_tilesets/"

const EXAMPLES_RELATIVE_PATH = "examples/"
const MAIN_SCENE_RELATIVE_PATH = "scenes/example_world.tscn"
